...
export default function Consulter(){
    return (
        ...
        <Link  href="/Rendezvs"><div className="p-10 h-full flex flex-col sm:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
       ...
       <span className=" font-bold text-[#527C88] text-xl self-end mx-12 mb-20 underline"><Link  href="/Rendezvs"> Autre motif de consultation..</Link></span> 
        </div>
        </>
    )
}